...
void CXBMCApp::UpdateSessionMetadata()
{
  ...
  {   
    ...
    {
      CLog::Log(LOGDEBUG, "Thumbnail extracted {}", IMAGE_FILES::URLFromFile(currentPlayingItem->GetArt("thumb")));
      builder.putString(CJNIMediaMetadata::METADATA_KEY_ART_URI, IMAGE_FILES::URLFromFile(currentPlayingItem->GetArt("thumb")));
    }
